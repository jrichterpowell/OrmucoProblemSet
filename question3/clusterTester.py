...
ports  = [i for i in range(6555,6556)]

nodes = [Node(5,clusterNames[i], ports[i], position=(random.randint(-10,10), random.randint(-10,10))) for i in range(1)]
if __name__ == "__main__":
    ...
    c.getDistances()
    time.sleep(7)
    json = '''ou were on your way home when you died.
